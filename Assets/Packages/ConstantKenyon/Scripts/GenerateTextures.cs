...
public class GenerateTextures : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        this.transform.localScale = new Vector3(initScale, initScale, 0);
    ...
    void Update()
    {
        ...
        this.transform.localScale += new Vector3(scaleGrowth, scaleGrowth, 0) * Time.deltaTime;
        ...
        {
            timeCreated += 0.1f;
            mySmoke.transform.localScale += new Vector3(scaleGrowth * smokeGrowth, scaleGrowth * smokeGrowth, 0 * smokeGrowth) * Time.deltaTime;
